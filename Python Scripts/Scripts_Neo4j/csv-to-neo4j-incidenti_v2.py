...
incidents_csv_files = [
   ...
   #'../../Datasets/2020/csv_incidentiMarzo.csv',
   # '../../Datasets/2020/csv_incidentiAprile.csv',
   # '../../Datasets/2020/csv_incidentiMaggio.csv',
   # '../../Datasets/2020/csv_incidentiGiugno.csv',
   # '../../Datasets/2020/csv_incidentiLuglio.csv',
   # '../../Datasets/2020/csv_incidentiAgosto.csv',
   # '../../Datasets/2021/csv_incidentiSettembre.csv',
   # '../../Datasets/2021/csv_incidentiOttobre.csv',
   # '../../Datasets/2021/csv_incidentiNovembre.csv',
   # '../../Datasets/2021/csv_incidentiDicembre.csv',
    
    #Incidenti 2021
    #'../../Datasets/2021/csv_incidentiGennaio.csv',
    #'../../Datasets/2021/csv_incidentiFebbraio.csv',
    #'../../Datasets/2021/csv_incidentiMarzo.csv',
    #'../../Datasets/2021/csv_incidentiAprile.csv',
    #'../../Datasets/2021/csv_incidentiMaggio.csv',
    #'../../Datasets/2021/csv_incidentiGiugno.csv',
    #'../../Datasets/2021/csv_incidentiLuglio.csv',
    #'../../Datasets/2021/csv_incidentiAgosto.csv',
    #'../../Datasets/2021/csv_incidentiSettembre.csv',
    #'../../Datasets/2021/csv_incidentiOttobre.csv',
    #'../../Datasets/2021/csv_incidentiNovembre.csv',
    #'../../Datasets/2021/csv_incidentiDicembre.csv',
