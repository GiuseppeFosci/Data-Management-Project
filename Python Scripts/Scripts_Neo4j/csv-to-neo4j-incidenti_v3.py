...
incidents_csv_files = [
    # Lista dei file CSV da importare
    ...
    '../../Datasets/2020/csv_incidentiSettembre.csv',
    '../../Datasets/2020/csv_incidentiOttobre.csv',
    '../../Datasets/2020/csv_incidentiNovembre.csv',
    '../../Datasets/2020/csv_incidentiDicembre.csv',
    # Aggiungi altri file CSV se necessario
]
...
# Inserisci i dati in Neo4j leggendo i file CSV
